...
export const client : CustomClient = new CustomClient(config.paths.databases, 3000, {intents: 3276799, partials: [Partials.Message, Partials.Channel, Partials.Reaction, Partials.User]});
